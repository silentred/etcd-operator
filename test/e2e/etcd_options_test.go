...
func TestConfigUpdate(t *testing.T) {
	// TODO: per-member Pod delete + recreate is M3 — see dispatch step 6
	// in internal/controller/etcdcluster_controller.go.
	t.Skip("blocked on M3 per-member repair; Pod delete + recreate that applies the new spec is not yet implemented")
